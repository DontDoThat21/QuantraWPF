...
namespace Quantra.Services
{
    ...
    public class SentimentExtremeSignalService
    {
        ...
        private readonly Quantra.Modules.SentimentPriceCorrelationAnalysis _sentimentPriceCorrelationAnalysis;
            ...
            UserSettings userSettings = null)
        {
            ...
            _sentimentPriceCorrelationAnalysis = new Quantra.Modules.SentimentPriceCorrelationAnalysis(userSettings);
