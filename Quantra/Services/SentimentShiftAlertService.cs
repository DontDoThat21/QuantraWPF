...
using Quantra.Modules; // <-- Add this line
...
namespace Quantra.Services
{
    ...
    /// </summary>
    public class SentimentShiftAlertService : ISentimentShiftAlertService
    {
        private readonly Quantra.Modules.SentimentPriceCorrelationAnalysis _sentimentAnalysis;
        ...
        public SentimentShiftAlertService(UserSettings userSettings = null)
        {
            ...
            _sentimentAnalysis = new Quantra.Modules.SentimentPriceCorrelationAnalysis(_userSettings);
