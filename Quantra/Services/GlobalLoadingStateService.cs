...
namespace Quantra.Services
{
    ...
    public static class GlobalLoadingStateService
    {
        ...
        public static async System.Threading.Tasks.Task WithLoadingState(System.Threading.Tasks.Task operation)
        {
            try
            {
        ...
        public static async System.Threading.Tasks.Task<T> WithLoadingState<T>(System.Threading.Tasks.Task<T> operation)
        {
            try
            {
                SetLoadingState(true);
